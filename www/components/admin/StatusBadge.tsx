  ...
  return (
    <>
      ...
      <button
        ...
        disabled={disabled}
        className={cn(
          'flex items-center gap-1.5 sm:gap-2 px-2 sm:pl-3 sm:pr-2 py-1 sm:py-1.5 rounded-lg text-[10px] sm:text-xs font-semibold border cursor-pointer transition-colors',
